...
{
  return 0;
} /* ImpTypeRefDcm_NegativeResponseCodeType Wrap_HBG_StatusRdcHsInaktivereignis( ImpTypeArrayDcm_StatusRdcHsInaktivereignisReadDataType Data ) */
...
{
  return 0;
} /* ImpTypeRefDcm_NegativeResponseCodeType Wrap_HBG_StatusRdcHsKalibrierereignis( ImpTypeArrayDcm_StatusRdcHsKalibrierereignisReadDataType Data ) */
...
{
  return 0;
} /* ImpTypeRefDcm_NegativeResponseCodeType Wrap_HBG_UWB_RdcPosition(ImpTypeValDcm_RdcPositionReadDataType* Data) */
